...
<table border="0" width="96%">
  <tr>
    <td width="50%">
      ...
      <table border="0" width="100%" background="../Image/LeaveBal.gif" height="32">
        <tr>
          <td width="100%" height="28">&nbsp;<BR><BR></td>
        </tr>
      </table>
    </td>
    <td width="50%"></td>
  ...
  <table  border="0" >
  <tr><form method="POST" action="leavebalance4.asp" name="frmLeaveApproval">
    ...
    <!--<FONT 
      class="marineblack style=" style="FONT-SIZE: x-small" large? 
      FONT-SIZE:>--><FONT class="marineblack" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Employee ID :</FONT>
...
<!--
      <select name=cboempid style="HEIGHT: 22px; LEFT:83px; TOP: 8px; WIDTH: 300px" onchange="if(options[selectedIndex].value) href=('leavebalance4.asp?cboempid=' + options[selectedIndex].value)" name="cboempid" > -->
      <select name=cboempid style="HEIGHT: 22px; LEFT:83px; TOP: 8px; WIDTH: 300px"  > 
                ...
                ssql ="Exec sp_Wls_selApprovalAuthority '" + Session("Regisno") + "','HRLS','','','" + Session("EmpID") + "','" + Session("EmpID") + "','BY_AUTHORITY'"
			  	...
			  	Do Until webdbRecordset.EOF
 					...
 					if ( trim(webdbRecordset.Fields("empid")) = Request.form("cboempid") ) then
			...
			%></select>&nbsp;&nbsp;&nbsp;<INPUT class=small id=button1 name=button1 style="LEFT: 200px; TOP: 107px" type=submit value=Search>&nbsp;&nbsp;<td width ="2%">&nbsp;</td>  </P>
			<td width="100%" align="left">
			<!--<%Response.Write "<a href=""leaveapp3.asp?employeeid=" + Request.form("cboempid") + """>"%><font class="marineblue"><u>Leave 
            Application</u></font> </td> -->
...
<!--      <P>
<%Response.Write "<a href=""leaveapp3.asp?employeeid=" + Request("cboempid") + """>"%><font class="marineblue"><u>Leave 
      Application<BR> </u></font></P>-->
 </td>
 </tr>
  <TR>
