...
<script language="javascript">
	function search(){
		document.frmLeaveApp.txtAction.value ="Search"
		}
</script>
        ...
        <tr>
          <td width="100%" height="10">
            <form method="POST" action="leaveapp2.asp" name="frmLeaveApp">
              ...
              </select><input name=txtAction size="20"> 
				<input type="submit" value="Refresh" name="cmdRefresh" onclick=search() style="font-size: 8pt">              
              </p>
