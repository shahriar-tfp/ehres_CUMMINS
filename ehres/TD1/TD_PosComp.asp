 ...
 Employee ID :
        ...
        <TR>
           ...
           <FONT class=small><b>Position&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> </FONT>
            <select name=cboempid style="HEIGHT: 22px; LEFT:83px; TOP: 8px; WIDTH: 400px"  onchange=Change()>  
                ...
                ssql ="Exec sp_WTD_SelPosition '" + Session("Regisno") + "'"
			  	...
			  	Do Until webdbRecordset.EOF
 				    ...
 				    if tmpEmpID = "" then
					      tmpEmpID = trim(webdbRecordset.Fields("description"))
  ...
  <TR>
    ...
    <tr>
      ...
      <td bgcolor="#f3f3f3" width="80"><font class="marineblack">Position</font></td>
      ...
      <td bgcolor="#f3f3f3" width="50"><font class="marineblack">Score</font></td>
            ...
            <%     page_size =10
                    ...
                    if Request.Form("cboempid") ="ALL" or tmpEmpID ="ALL" then                
						 ssql = "Exec sp_WTD_SelGrpPosComp '" + Session("Regisno") + "','" + Request.Form("cboempid") + "','ALL'"		
					else	
					     ssql = "Exec sp_WTD_SelGrpPosComp '" + Session("Regisno") + "','" + Request.Form("cboempid") + "','One'"
					end if
